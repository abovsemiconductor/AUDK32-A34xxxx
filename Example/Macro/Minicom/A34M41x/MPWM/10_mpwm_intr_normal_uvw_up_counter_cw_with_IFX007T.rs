...
#    Signal                       : 0x1 (PWM)
# 
# 9. Duty                         : [ 0 m 600 0 640 0 640 640 ]
#    Signal                       : m (PWM)
#    U-High Duty                  : 600
#    U-Low Duty                   : 0
#    V-High Duty                  : 640
...
send "pwm 0 -ped 640 -intr 0xff -sdp u 0 0 l l l l l l"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : on UL : off / VH : off VL : on / WH : off WL : off
send "duty 0 m 600 0 640 0 640 640"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : on UL : off / VH : off VL : off / WH : off WL : on
send "duty 0 m 600 0 640 640 640 0"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : off UL : off / VH : on VL : off / WH : off WL : on
send "duty 0 m 640 640 600 0 640 0"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : off UL : on / VH : on VL : off / WH : off WL : off
send "duty 0 m 640 0 600 0 640 640"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : off UL : on / VH : off VL : off / WH : on WL : off
send "duty 0 m 640 0 640 640 600 0"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
# UH : off UL : off / VH : off VL : on / WH : on WL : off
send "duty 0 m 640 640 640 0 600 0"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
...
send "duty 0 m 640 640 640 640 640 640"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
