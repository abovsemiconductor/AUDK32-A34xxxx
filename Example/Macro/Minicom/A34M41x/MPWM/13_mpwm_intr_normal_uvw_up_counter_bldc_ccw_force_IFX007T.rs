...
#    Signal                       : 0x1 (PWM)
# 
# 9. BLDC                              : [ 0 -ref e -mode f -phdly 100 -dir b -duty 600 640 600 640 600 640 0 640 ]
#    Reference Board Enable (-ref)     : e (Enable)
#    Mode (-mode)                      : f (Force Commutation)
#    Phase Update Delay Count (-phdly) : 100
#    Direction (-dir)                  : b (Backward : Counter Clockwise)
#    UVW Duty (-duty)
#      U-High Duty                     : 600
#      U-Low Duty                      : 640
#      V-High Duty                     : 600
...
send "bldc 0 -ref e -mode f -phdly 100 -dir b -duty 600 640 600 640 600 640 0 640"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
