...
#    Signal                       : 0x1 (PWM)
# 
# 9. BLDC                              : [ 0 -ref e -mode h -hall 0 2 0 3 0 4 -dir f -duty 600 640 600 640 600 640 0 640 ]
...
#    Direction (-dir)                  : f (Forward : Clockwise)
#    UVW Duty (-duty)
#      U-High Duty                     : 600
#      U-Low Duty                      : 640
#      V-High Duty                     : 600
...
send "bldc 0 -ref e -mode h -hall 0 2 0 3 0 4 -dir f -duty 600 640 600 640 600 640 0 640"
expect {
    "<MPWM> # "
    break
    timeout 5 goto end
