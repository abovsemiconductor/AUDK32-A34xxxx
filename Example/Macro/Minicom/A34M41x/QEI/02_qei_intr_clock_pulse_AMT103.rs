# A. Description
#    A list of commands here configures QEI module and generates clock pulse (rising and falling Phase-A edge) interrupt.
#
# B. Preparation
...
# 1. Channel                      : 0 (QEI0)
#
# 2. Config (cfg)                 : [ 0 i 0x08 q b m d 0xFFFFF ]
#    Operation                    : i (Interrupt)
#    Interrupt Enable             : 0x08 (Rising/Falling Ph-A Edge)
...
send "cfg 0 i 0x08 q b m d 0xFFFF"
expect {
    "<QEI> # "
    break
    timeout 5 goto end
