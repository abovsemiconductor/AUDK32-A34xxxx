# A. Description
#    A list of commands here configures QEI module and generates index pulse interrupt and clear position counter by index, phase-A and phase-B signal.
#
# B. Preparation
...
# 1. Channel                      : 0 (QEI0)
#
# 2. Config (cfg)                 : [ 0 i 0x01 q b i 4 0xFFFFF ]
#    Operation                    : i (Interrupt)
#    Interrupt Enable             : 0x01 (Index Pulse Rising Edge)
#    Signal Mode                  : q (Quadrature)
#    Capture Edge Mode            : b (Phase-A & Phase-B Edge)
#    Counter Reset                : i (Index Reset)
#    Index Count by Ph-A and Ph-B : 4 (Phase-A Low & Phase-B Low)
...
send "cfg 0 i 0x01 q b i 4 0xFFFFF"
expect {
    "<QEI> # "
    break
    timeout 5 goto end
