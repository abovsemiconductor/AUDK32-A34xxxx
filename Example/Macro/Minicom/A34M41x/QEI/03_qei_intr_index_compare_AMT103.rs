# A. Description
#    A list of commands here configures QEI module and generates index compare interrupt.
#
# B. Preparation
...
# 1. Channel                      : 0 (QEI0)
#
# 2. Config (cfg)                 : [ 0 i 0 q b m 0xFFFFF ]
...
#
# 3. Compare Config (cmpcfg)      : [ 0 i e 0x1F ]
#    Counter Type                 : i (Index)
