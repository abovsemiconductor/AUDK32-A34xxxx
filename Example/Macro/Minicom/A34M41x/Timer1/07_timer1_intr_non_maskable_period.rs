# A. Description
#    A list of commands here configures timer1 and generates an non-maskable period interrupt.
#
# B. Preparation
#    N/A
#
...
#
# 3. Config                    : [ 0 n p h 3200 3200 -io o ]
...
send "config 0 n p h 3200 3200 -io o"
expect {
    "<TIMER1> # "
    break
    timeout 5 goto end
